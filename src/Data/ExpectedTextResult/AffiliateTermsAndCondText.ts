export const affiliateTermsAndConditionsText = `Effective from: 25.05.2018

Last updated: 25.03.2025

This is an agreement (“The Affiliate Agreement”) between you (“you” or “Affiliate”) and King Billy Partners, the Affiliate Program promoting a gaming website www.kingbillycasino.com operated by Dama N.V., a company registered and established under the laws of Curaçao, with registration number 152125 and registered address at Scharlooweg 39, Willemstad, Curaçao. Dama N.V. is licensed and regulated by Curaçao Gaming Control Board (license no. OGL/2023/174/0082).(“Company”, “us” or “we”).
...
1.9. “Company” shall mean Dama N.V. and any other company within our group of, including our parent companies, their parent companies and all of the subsidiaries of these respective companies.

1.10. “Company Websites” means the website www.kingbillycasino.com or other such websites (including mirror websites) as may be added to this Affiliate Program from time to time;

1.11. “Commission” means the percentage of the Net Gaming Revenue (Rev.share structure) calculated by the formula: (Net Gaming Revenue -35% Admin Fee) * Commission %. Admin Fee includes payment system fees + game providers fees. Where applicable, a fixed amount for a New Customer (CPA structure) as set out in the Commission Structures, or a combination of 2 commission structures (CPA + Rev.share) are calculated in the commission formula.
...
1.15. “Net Gaming Revenue” or “NGR” means all monies received by Company from New Customers which is calculated by the formula: Bets - Winnings - Bonuses - Chargebacks. For the avoidance of doubt, all Net Gaming Revenue amounts mentioned above are only related to New Customers referred to Company Websites by the Affiliate Website(s).
...
1.17. In any given month, if a Customer generates a negative net revenue of at least €10,000, will be deemed to be, for the purposes of this section, a 'High-roller'.
...
King Billy Affiliates: Branded Traffic (use of our brand name in adwords and/or in a domain name as well as in other related traffic) is completely forbidden unless it is approved upon a prior consent with Affiliate Program. All branded traffic sent by Affiliate Links to Company Websites will be considered irrelevant and paid based on the minimal Revenue share deal. You hereby acknowledge any New Customer attracted by using branded keywords in any type of media does not count as a valid New Customer under the Affiliate Agreement. Hereby any Commission in relation to such New Customers can be voided or paid on the minimal Revenue share deal at the Company's sole discretion.
...
4.4. We shall use and process the following personal data of an Affiliate or any Affiliate employee, as follows: your username for logging in, your email address, name, date of birth, your country and address, and financial data for the purposes of ensuring a high level of security, fulfilling the AML legal requirements and for managing our business relationship.
...
6.2. The commission is calculated at the end of each month and payments shall be made on a monthly basis upon the provided invoices in arrears, not later than the 25th of the following calendar month.

6.3. Payment of Commission will be made via 3 payment options: Bank Wire, Skrill or Affiliate Account. King Billy Partners powered by Income Access affiliate Software supports only Bank Wire or Skrill. King Billy Partners supports Affiliate Wallet with the following available options: Coinspaid (BTC only) as well as fiat payouts via Bank wire, Neteller and Skrill. Both affiliate platforms are operating within the conditions specified in the provisions. All Affiliates are expected to provide Finance with invoices based on their earned commission onto: finance@kingbillycasino.com on a monthly basis. Affiliates can secure their timely commission payouts by invoicing their commissions before 15th of each month for the last qualifying period.

6.4. A minimum threshold of €100 (hundred euro) or BTC equivalent and limited to €1000 (thousand euro) or BTC equivalent may be transferred to an Affiliate e-Wallet at one time upon a previously provided invoice.

6.5. A minimum commission threshold of €300 is available for Bank Wire transfers upon a previously provided invoice.
...
6.7. In case any of our available cryptocurrencies' exchange rate drop exceeds 50 percent during the last month, we reserve the right to recalculate the final Affiliate Commission on Income Access, based on the running cryptocurrency’s exchange rate.

6.8.The Affiliate may, at the Company’s sole discretion, be provided with the opportunity to restructure its commission structure.

6.9. Players who set a cool-off, self-excluded or disabled their accounts the same qualifying month, should be deemed to be non-qualified players (later as NQP)

6.10. All NQP's shall not meet CPA requirements the same qualifying month and cannot trigger CPA structure.

6.11. CPA and Hybrid (CPA part) earnings are applicable solely to players who have deposited within 62 days of their registration.

6.12. The Affiliate’s acceptance of a Commission payment shall constitute the full and final settlement of the balance due for the relevant period. In case the Affiliate disagrees with the balance due as reported, he or she shall notify the Company within fourteen (14) calendar days and clearly state reasons of the disagreement. Failure to notify the Company within this time limit shall be considered as an irrevocable acknowledgment of the balance due for the relevant period.

6.13. The Commission shall be deemed to be exclusive of value added tax or any other applicable tax. The Affiliate shall have the sole responsibility to pay any and all taxes, levies, charges and any other money payable or due to any tax authority, department or other competent entity as a result of the compensation generated under the Affiliate Agreement.

6.14.King Billy Partners powered by Income Access is featuring S2S (Server-to-Server Pixels) software module. Affiliates, participating in the Affiliate Program, can expect sales data sent in near real-time by the S2S relay.

7. HIGH-ROLLER POLICY

7.1 If the total Net Gaming Revenue for the Customer, in the qualifying month, for a Brand is negative of at least €10 000 or greater, then the High-Roller Policy as set out hereunder, will apply:

7.2. The negative Net Gaming Revenue generated by the High-Roller shall affect Monthly Net Gaming Revenue in the qualifying month, but all commission adjustments are to be made in the subsequent months. The commission of the qualifying month remains unchanged.

7.3 In case of Monthly negative NGR in the qualifying month – the amount has to be carried over to the next periods and deducted from the future Net Gaming Revenue generated by the same High-Roller before the final commission count.

7.4 The negative balance carryover cannot be set-off against other Customers’ future Net Gaming Revenue;

7.5 The negative balance carryover cannot be greater than the total monthly negative Net Gaming Revenue for the particular Brand on the Affiliate account in the qualifying period;

7.6 A positive NGR of a High-Roller in subsequent months will be reduced to nil before the final commission count until the High-Roller's carried over negative NGR is fully refunded.

7.7 A negative balance will not be increased by future negative Net Gaming Revenue unless the High-Roller meets the qualifying criteria in subsequent months.

7.8 If a High-Roller meets the qualifying criteria in subsequent months, a negative balance will be increased by the amount equal to a negative Net Gaming Revenue balance in the qualifying month.

7.9 All positive High-Roller balances under €500 are carried over to the next periods until the amount of €500 and over is accumulated . Once it is reached, the cumulative amount of €500 and over is subtracted from the remaining High-Roller’s negative balance. The commission correction is based on the following formula:
Commission = (NGR – Positive HR NGR – 35% Admin Fee) x RS%.
In case of any commission correction, all the affiliates should be preliminary informed in details via email from finance@kingbillycasino.com about the potential commission adjustments. Thus, the invoices must be issued right after the confirmation of commission correction procedure before 15th of each month.
